...
ggml_tensor * llama_model_qwen4exp::graph::build_attn_qsa_masked(
    ...
    return build_attn_mha(q_cur, k_cache, v_cache, nullptr, kq_mask_top_k, nullptr, nullptr, kq_scale, il);
}
...
ggml_tensor * llama_model_qwen4exp::graph::build_attn_qsa_gathered(
    ...
    return build_attn_mha(q_cur, k_sel, v_sel, nullptr, mask_sel, nullptr, nullptr, kq_scale, il);
}
